<x-layouts.app>
    <div class="flex flex-col items-center border-b bg-white py-4 sm:flex-row sm:px-10 lg:px-20 xl:px-32">
        <a class="text-2xl font-bold text-gray-800" href="#">sneekpeeks</a>
    ...
    <div class="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div class="px-4 pt-8">
                ...
                @foreach ($cart->products as $product)
                    <div class="flex flex-col rounded-lg bg-white sm:flex-row">
                        ...
                        <div class="flex w-full flex-col px-4 py-4">
                            ...
                            <span class="float-right text-gray-400">{{ $product->quantity }} {{ __('db') }}</span>
            ...
            <form class="mt-5 grid gap-6">
                <div class="relative">
                    <input class="peer hidden" id="radio_1" name="radio" type="radio" checked />
                    <span
                ...
                <div class="relative">
                    <input class="peer hidden" id="radio_2" name="radio" type="radio" checked />
                    <span
                        class="absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white peer-checked:border-gray-700"></span>
                    <label
                        class="flex cursor-pointer select-none rounded-lg border border-gray-300 p-4 peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50"
        ...
        <div class="mt-10 bg-gray-50 px-4 pt-8 lg:mt-0">
            ...
            <div class="">
                <label class="mb-2 mt-4 block text-sm font-medium" for="email">Email</label>
                <div class="relative">
                    <input
                        class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                        id="email" name="email" type="text" placeholder="your.email@gmail.com" />
                ...
                <label class="mb-2 mt-4 block text-sm font-medium" for="card-holder">Card Holder</label>
                <div class="relative">
                    <input
                        class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm uppercase shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                        id="card-holder" name="card-holder" type="text" placeholder="Your full name here" />
                    <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                        <svg class="h-4 w-4 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <label class="mb-2 mt-4 block text-sm font-medium" for="card-no">Card Details</label>
                <div class="flex">
                    <div class="relative w-7/12 flex-shrink-0">
                        <input
                            class="w-full rounded-md border border-gray-200 px-2 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                            id="card-no" name="card-no" type="text" placeholder="xxxx-xxxx-xxxx-xxxx" />
                        <div class="pointer-events-none absolute inset-y-0 left-0 inline-flex items-center px-3">
                    ...
                    <input
                        ...
                        name="credit-expiry" type="text" placeholder="MM/YY" />
                    <input
                        class="w-1/6 flex-shrink-0 rounded-md border border-gray-200 px-2 py-3 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                        name="credit-cvc" type="text" placeholder="CVC" />
                </div>
                <label class="mb-2 mt-4 block text-sm font-medium" for="billing-address">Billing Address</label>
                <div class="flex flex-col sm:flex-row">
                    <div class="relative flex-shrink-0 sm:w-7/12">
                        <input
                            class="w-full rounded-md border border-gray-200 px-4 py-3 pl-11 text-sm shadow-sm outline-none focus:z-10 focus:border-blue-500 focus:ring-blue-500"
                            id="billing-address" name="billing-address" type="text"
                    ...
                    <input
                        ...
                        name="billing-zip" type="text" placeholder="ZIP" />
                </div>
            ...
            <button class="mb-8 mt-4 w-full rounded-md bg-gray-900 px-6 py-3 font-medium text-white">Place
                Order</button>
        </div>
    </div>
