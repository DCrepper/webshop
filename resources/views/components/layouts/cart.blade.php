<div class="fixed right-0 top-0 hidden h-full w-full max-w-xs transform overflow-y-auto border-l-2 border-gray-300 bg-white px-6 py-4 transition duration-300"
    :class="cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'" x-init="() => { $el.classList.remove('hidden'); }">
    ...
    <div class="mt-8">
        <form class="flex items-center justify-center">
            ...
            <button
                class="ml-3 flex items-center rounded bg-blue-600 px-3 py-2 text-sm font-medium uppercase text-white hover:bg-blue-500 focus:bg-blue-500 focus:outline-none">
                <span>Apply</span>
            </button>
        </form>
    </div>
    <a class="mt-4 flex items-center justify-center rounded bg-blue-600 px-3 py-2 text-sm font-medium uppercase text-white hover:bg-blue-500 focus:bg-blue-500 focus:outline-none"
        href="{{ route('checkout.index') }}" wire:navigate>
        <span>Checkout</span>
